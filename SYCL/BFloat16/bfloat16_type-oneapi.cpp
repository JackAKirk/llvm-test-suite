...
//==----------- bfloat16_type_oneapi.cpp - SYCL bfloat16 type test ---------==//
//
...
cl::sycl::ext::oneapi::experimental::bfloat16 bf1(1.0f);
cl::sycl::ext::oneapi::experimental::bfloat16    bf2 = -bf1;
cl::sycl::ext::oneapi::experimental::bfloat16    bf3 = +bf1;
cl::sycl::ext::oneapi::experimental::bfloat16 bf4(+bf1);
